...
export function MenuSection({
  ...
  return (
    <section id={menuSectionId(categoryId)} className={scrollMarginClassName}>
      <h2 className="mb-8 whitespace-pre-line border-b border-brand-primary/18 pb-3 font-serif text-2xl font-semibold tracking-wide text-brand-ink sm:text-[1.65rem]">
        {title}
      </h2>
      {children}
    </section>
