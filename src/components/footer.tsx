  ...
  return (
    <footer className="border-t border-brand-line bg-brand-card py-12 text-center text-sm text-brand-body shadow-[0_-1px_0_rgba(31,35,38,0.04)]">
      <div className="flex justify-center">
        <SiteLogo variant="footer" className="justify-center" lightUiTone="subtleContrast" />
      </div>
      <p className="mt-4 font-serif text-base tracking-[0.2em] text-brand-ink">SAKE Vienna</p>
      ...
      <div className="mt-5 flex flex-col items-center gap-2">
        <Image src={`https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=${encodeURIComponent(orderUrl)}`} alt="QR Code Bestellseite" width={120} height={120} className="rounded-md border border-brand-line" />
